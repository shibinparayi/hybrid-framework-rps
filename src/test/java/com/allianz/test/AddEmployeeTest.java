...
public class AddEmployeeTest extends AutomationWrapper {
	...
	public void uploadInvalidDisplayPictureTest() {
		...
		File file = new File("src/test/resources/files/Path.txt");
		...
		// driver.findElement(By.xpath("//input[@type='file']")).sendKeys("C:\\Automation
		// Session\\automation_workspace\\HealthManagementAutomation\\pom.xml");
